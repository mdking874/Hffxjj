...
if ((event.body.toLowerCase() == "@everyone নোটিশ") || (event.body.toLowerCase() == "khaicho")) {
     return api.sendMessage("🎶♥⃝𝐒𝐎𝐏𝐍𝐎𝐁𝐈𝐋𝐀𝐒𝐇 ☘️̤̤̤̈̈̈̈͜͡♥⃝🎵🌼⃪⃝ 𝐌𝐔𝐒𝐈𝐂≛⃝🧡🪄𝐁𝐀𝐍𝐃☘️𒍮ꗥ
(আসসালামালাইকুম) 
প্রিয়  ভাই বোন তোমাদের উদ্দেশ্যে 
একটা কথাই বলি তোমরা যারা যারা লোগো এখনো লাগাও নাই 
তারা এখনই লোগোও লাগায় নেও  লোগো বানানো জন্য  অবশ্যই বলবা লোগো করে দেয়া করে দেয়া হবে আর যারা লোগো লাগাতে পারবে না নিজ দোয়া সবাইকে
(CREATOR-JAHID দের পক্ষ থেকে সবাই কে জানাইতেছি 
 ভালোবাসার অবিরাম! 🫰💖😘

সবাই কে বিশেষ ভাবে আমন্ত্রণ জানাচ্ছি 💚🥀🥰

@everyone 
❌Text Off 10 Minit❌", threadID);
   };
}
